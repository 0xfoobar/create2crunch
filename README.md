...
To search only for leading zeroes and ignore total zeroes, set the final argument to a number greater than 20, such as 255. On an RTX 3090 this gives a speedup from ~2100m attempts/sec to ~2150 attempts/sec.
